...
@Injectable()
export default class BaseService<T extends Document<any, any, any>> {
  constructor(readonly baseRepository: BaseRepository<T>) {}

  public async distinct(field: string, query = {}): Promise<any> {
    return await this.baseRepository.distinct(field, query);
  }
  ...
  public async findOneBy(query = {}, options = {}): Promise<any | null> {
    return await this.baseRepository.findOneBy(query, options);
  }
  ...
  public async findOneById(
    ...
    return await this.baseRepository.findOneById(id, options);
  }
  ...
  public async findManyBy(query = {}, options = {}): Promise<any | null> {
    return await this.baseRepository.findManyBy(query, options);
  }
  ...
  public async updateOneById(
    ...
    const result = await this.baseRepository.updateOneById(id, data, options);
